This application demonstrate a rule based fraud detection module. To demonstrate the fraud detection rules, a sample e-commerce application is built. The main page contains few sample items, add to card button and checkout page. The checkout page when submitted triggers set of fraud rules. If the transaction is blocked dues to fraud rules, the blocked transactions are displayed for the admin to view in the admin page. The filters for fraudulent transactions rules such as:

1. Amount > $2000
2. Different country or cross country transactions
3. Too many transactions in a short period
4. Night-time purchases

About the application

E-commerce Demo with Fraud Screening
